...
const ServicesPage = () => {
  return (
    <section className="py-10">
      <h1 className="mb-20 text-5xl about-headings">
        Services Provided
      ...
      <div className="grid grid-cols-1 gap-20 md:grid-cols-2">
        {services.map(({ image, name }, i) => {
          ...
          return (
            <div
              className={`h-auto mx-auto md:mx-0 bg-gray-200 w-96 ${
            ...
            >
              ...
              <h3 className="px-1 text-3xl font-semibold text-center uppercase py-7">
                {name}
              </h3>
            </div>
          );
